...
const AboutPage = () => {
  ...
  useEffect(() => {
    async function fetchCounts() {
      const [{ count: projectsCount }, { count: certsCount }] = await Promise.all([
        supabase.from("projects").select("*", { count: "exact", head: true }),
        supabase.from("certificates").select("*", { count: "exact", head: true }),
      ]);
      setTotalProjects(projectsCount || 0);
      setTotalCertificates(certsCount || 0);
    }
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              Motivated Computer Science graduate with a proven ability to deliver scalable and production-ready software solutions. Skilled in designing robust backend systems, building seamless user interfaces, and optimizing for performance. Demonstrated expertise across the full software development lifecycle, with a focus on impactful business outcomes, code quality, and rapid learning.
            </p>
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/12Mwj8hYh0v6tNQNZtwxHCVtyMnZLzKBA/" className="w-full lg:w-auto">
                <button
                  data-aos="fade-up"
                  data-aos-duration="800"
