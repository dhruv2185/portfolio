...
const WORDS = ["Problem Solving", "Tech Enthusiast"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Flutter", "Django", "Flask"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/dhruv2185/" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/dhruv-ghevariya-5a054022a/" },
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Solving complex problems by designing efficient, scalable, and reliable software solutions that drive impactful results.
                </p>
